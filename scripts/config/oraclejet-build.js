 ...
 */
    ...
    copyCustomLibsToStaging: {
        fileList: [
          ...
          //   src: ['**'], // wild card match all js files
          //   dest: 'web/js/libs/ckeditor'
          // },
          {
            cwd: 'node_modules/@ckeditor/ckeditor5-build-classic/build',
            src: ['**'], // wild card match all js files
            dest: 'web/js/libs/ckeditor5-classic'
          },
          {
            cwd: 'node_modules/requirejs-plugins/',
            src: ['src/json.js'],
            dest: 'web/js/libs/require-json'
          }
        ]
      },
